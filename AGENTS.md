...
- Current scope: IBL mouse 2AFC and macaque RDM tasks with Sticky-Q, Bayesian observer, PPO baselines, Hybrid DDM+LSTM, R-DDM, and adaptive-control agents. The PRL transfer path is wired end to end; DMS has a schema-valid environment scaffold. 187 tests pass with `MPLBACKEND=Agg` as of 2026-07-08.
